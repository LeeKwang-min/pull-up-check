...
function HomePage() {
  return (
    <div className="flex flex-col min-h-[85vh] py-8">
      <div className="mb-8">
        <p className="text-xs text-stone-500 tracking-widest uppercase font-[Barlow_Condensed]">오늘의 턱걸이</p>
        <h1 className="text-3xl font-bold tracking-tight mt-1">
          풀업 <span className="text-amber-500">체크</span>
        </h1>
      </div>

      <div className="bg-stone-900 rounded-2xl p-6 border border-amber-500/10 relative overflow-hidden">
        ...
        <div className="relative">
          <div className="text-6xl font-bold text-amber-500 leading-none font-[Barlow_Condensed]">
            --<span className="text-lg text-stone-500 ml-1">점</span>
          </div>
          <p className="text-xs text-stone-500 mt-1">최근 종합 점수</p>
        </div>
        <div className="flex gap-8 mt-6">
          <div>
            <div className="text-xl font-bold font-[Barlow_Condensed]">--</div>
            <div className="text-xs text-stone-500">총 횟수</div>
          </div>
          <div>
            <div className="text-xl font-bold font-[Barlow_Condensed]">--</div>
            <div className="text-xs text-stone-500">세트</div>
          </div>
          <div>
            <div className="text-xl font-bold font-[Barlow_Condensed]">--</div>
            <div className="text-xs text-stone-500">평균 템포</div>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-3 mt-auto pt-8">
        ...
        <Link
          to="/history"
          className="bg-stone-900 hover:bg-stone-800 text-stone-400 font-semibold py-3 px-6 rounded-2xl text-center transition-colors border border-stone-800 cursor-pointer"
        >
          기록 보기
        </Link>
      </div>
