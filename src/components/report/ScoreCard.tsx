...
export function ScoreCard({ label, score, color = '#F59E0B' }: ScoreCardProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-2 bg-stone-900 rounded-2xl p-5 border border-amber-500/10">
      <svg width="100" height="100" viewBox="0 0 100 100">
        ...
        <text x="50" y="62" textAnchor="middle" fill="#78716C" fontSize="9">
          / 100
        </text>
      </svg>
      <span className="text-xs text-stone-500 uppercase tracking-wider font-[Barlow_Condensed]">{label}</span>
    </div>
  );
}
