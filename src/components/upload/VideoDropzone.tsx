...
export function VideoDropzone({ onFileSelected }: VideoDropzoneProps) {
  ...
  return (
    ...
    >
      <svg className="mb-3" width="36" height="36" viewBox="0 0 24 24" fill="none" stroke={isDragOver ? '#F59E0B' : '#A8A29E'} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg>
      <p className="text-sm text-stone-300">영상을 끌어놓거나 탭하여 선택하세요</p>
      <p className="text-xs text-stone-500 mt-1">MP4, MOV, WebM</p>
